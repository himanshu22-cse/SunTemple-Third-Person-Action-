...
class AActor;
struct FHitResult;
#ifdef FIRSTPROJECT_LevelTransitionVolume_generated_h
...
public: \
	DECLARE_CLASS(ALevelTransitionVolume, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/FirstProject"), NO_API) \
...
private: \
	...
	NO_API ALevelTransitionVolume(const ALevelTransitionVolume&); \
public:
...
template<> FIRSTPROJECT_API UClass* StaticClass<class ALevelTransitionVolume>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FirstProject_Source_FirstProject_LevelTransitionVolume_h
